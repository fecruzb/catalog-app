...
export const list = async () =>
  axios.get("/authors", { baseURL, headers: { Authorization: Cookies.get("token") } })
...
export const read = async (id) =>
  axios.get(`/authors/${id}`, { baseURL, headers: { Authorization: Cookies.get("token") } })
...
export const create = async (author) =>
  axios.post("/authors", author, { baseURL, headers: { Authorization: Cookies.get("token") } })
...
export const remove = async (id) =>
  axios.delete(`/authors/${id}`, { baseURL, headers: { Authorization: Cookies.get("token") } })
